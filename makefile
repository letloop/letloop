...
local/lib/libblake3.so:
	...
	cd local/src/blake3/c/ && gcc -fPIC -DBLAKE3_NO_SSE2 -DBLAKE3_NO_SSE41 -DBLAKE3_NO_AVX2 -DBLAKE3_NO_AVX512 -shared -O3 -o libblake3.so blake3.c blake3_dispatch.c blake3_portable.c
	mkdir -p local/lib/
